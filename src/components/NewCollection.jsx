  ...
  return (
    <div>
        <div className='mx-auto max-w-2xl px-4 py-16 sm:pt-24 lg:max-w-7xl lg:px-8'>
            ...
            <p className='text-center mt-3 md:px-56'>Welcome to our online store! Discover a wide range of products, add to cart, place orders easily, and enjoy a smooth shopping experience.</p>
